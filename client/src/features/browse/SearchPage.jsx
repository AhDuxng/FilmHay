...
import SearchResult from '@/features/browse/components/SearchResult';
import { movieApi } from '@/shared/lib/api';
import { useBrowseMetadata, useQuery } from '@/shared/hooks/useMovies';
import { normalizeListPayload } from '@/shared/lib/helpers';
  ...
  return (
    <main className="mx-auto flex w-full max-w-container-max flex-grow flex-col gap-8 px-margin-mobile pb-12 pt-24 md:px-margin-desktop md:pb-16 md:pt-28">
      <header className="flex flex-col gap-6">
        <h1 className="text-ramp font-headline-lg-mobile md:font-headline-lg text-headline-lg-mobile md:text-headline-lg">Tìm kiếm & lọc phim</h1>
