const FilterSidebar = ({ filters, onChange, genres = [], countries = [], years = [] }) => {
    ...
    <aside className="w-full lg:w-64 flex-shrink-0 flex flex-col gap-6">
      <div className="glass-panel rounded-xl p-6 flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <select
            className="w-full bg-surface-container-high border-outline rounded-lg text-on-surface font-body-md text-body-md focus:ring-primary focus:border-primary p-2"
