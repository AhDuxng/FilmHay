...
import { useMoviesByCountry, useMoviesByGenre, useMoviesByYear, useMovieList, useBrowseMetadata } from '@/shared/hooks/useMovies';
import { usePageTitle } from '@/shared/hooks/usePageTitle';
import { LIST_TITLES } from '@/shared/lib/constants';
import { CONTENT_WRAP, PAGE_PADDING, slugToTitle } from '@/shared/lib/helpers';
import Loading from '@/shared/components/feedback/Loading';
import ErrorState from '@/shared/components/feedback/ErrorState';
import MovieGrid from '@/shared/components/media/MovieGrid';
  ...
  return (
    <main className={`${PAGE_PADDING} ${CONTENT_WRAP}`}>
      <div className="mb-5 flex flex-wrap items-end justify-between gap-3">
        <div>
          <h1 className="text-ramp text-3xl font-black">{title}</h1>
      ...
      {quickLinks.length ? (
        <div className="mb-6 rounded-2xl border border-outline bg-surface-container p-3">
      ...
      {data.items.length ? (
        ...
        <div className="rounded-2xl border border-outline bg-surface-container p-10 text-center text-secondary-fixed-dim">
