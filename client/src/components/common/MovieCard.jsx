...
export const MovieCard = ({
  ...
  return (
    <article className={`movie-card ${inSlider ? 'flex-none' : ''} ${widthClass} ${aspectClass} rounded-lg overflow-hidden bg-surface-container-high relative cursor-pointer group/card border border-white/5`}>
